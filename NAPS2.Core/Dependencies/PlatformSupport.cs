...
namespace NAPS2.Dependencies
{
    ...
    {
        public static readonly PlatformSupport Windows =
            new PlatformSupport(() => Environment.OSVersion.Platform == PlatformID.Win32NT);

        public static readonly PlatformSupport WindowsXp = Windows.And(new PlatformSupport(() =>
        ...
        public static readonly PlatformSupport Linux =
            new PlatformSupport(() => Environment.OSVersion.Platform == PlatformID.Unix);
