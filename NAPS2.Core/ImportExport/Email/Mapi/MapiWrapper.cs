...
namespace NAPS2.ImportExport.Email.Mapi
{
    public class MapiWrapper
    {
        ...
        private static MapIFileDescription[] GetFiles(EmailMessage message)
        {
            return message.Attachments.Select(attachment => new MapIFileDescription
            {
                position = -1,
        ...
        private static MapIFileDescriptionW[] GetFilesW(EmailMessage message)
        {
            return message.Attachments.Select(attachment => new MapIFileDescriptionW
            {
                position = -1,
                path = attachment.FilePath,
                name = attachment.AttachmentName
