...
namespace NAPS2.ClientServer
{
    public class ServerDiscovery
    {
        ...
        private static readonly byte[] MagicBroadcastBytes =
            {0x7f, 0x87, 0x00, 0x8b, 0x08, 0x87, 0x5d, 0xd3, 0x64, 0x1a};

        private static readonly byte[] MagicResponseBytes =
            {0xf4, 0x38, 0xb9, 0xa3, 0xf7, 0x37, 0xaf, 0x35, 0x41, 0xc7};
        ...
        public static void ListenForBroadcast(int serverPort)
        {
            ...
            while (true)
            {
                try
                {
                    ...
                    if (!receivedBytes.SequenceEqual(MagicBroadcastBytes)) continue;
